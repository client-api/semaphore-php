...
class ViewRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ViewRequest';
    ...
    */
    ...
    public function setProjectId(?int $projectId): static
    {
        ...
        if (($projectId < 1)) {
            throw new InvalidArgumentException('invalid value for $projectId when calling ViewRequest., must be bigger than or equal to 1.');
        }
