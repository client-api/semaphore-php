...
class ProjectUser implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProjectUser';
    ...
    */
    ...
    public function setId(?int $id): static
    {
        ...
        if (($id < 1)) {
            throw new InvalidArgumentException('invalid value for $id when calling ProjectUser., must be bigger than or equal to 1.');
        }
