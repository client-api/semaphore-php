...
class Environment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Environment';
    ...
    protected static array $openAPITypes = [
        ...
        'json' => 'string',
        'env' => 'string',
        'secrets' => '\ClientAPI\Semaphore\Model\EnvironmentSecret[]'
    ];
    ...
    */
    ...
    public function setProjectId(?int $projectId): static
    {
        ...
        if (($projectId < 1)) {
            throw new InvalidArgumentException('invalid value for $projectId when calling Environment., must be bigger than or equal to 1.');
        }
     ...
     * Gets secrets
     *
     * @return \ClientAPI\Semaphore\Model\EnvironmentSecret[]|null
     */
     ...
     * Sets secrets
     *
     * @param \ClientAPI\Semaphore\Model\EnvironmentSecret[]|null $secrets secrets
     *
     * @return $this
     */
