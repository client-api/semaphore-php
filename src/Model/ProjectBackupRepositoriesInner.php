...
/**
 * ProjectBackupRepositoriesInner Class Doc Comment
 *
 * @package  ClientAPI\Semaphore
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProjectBackupRepositoriesInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProjectBackup_repositories_inner';
    ...
    */
     ...
     * @return $this
     */
    public function setSshKey(?string $sshKey): static
    {
        if (is_null($sshKey)) {
