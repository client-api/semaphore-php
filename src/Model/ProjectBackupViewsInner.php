...
/**
 * ProjectBackupViewsInner Class Doc Comment
 *
 * @package  ClientAPI\Semaphore
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProjectBackupViewsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProjectBackup_views_inner';
    ...
    */
    ...
    public function setPosition(?int $position): static
    {
        ...
        if (($position < 0)) {
            throw new InvalidArgumentException('invalid value for $position when calling ProjectBackupViewsInner., must be bigger than or equal to 0.');
        }
