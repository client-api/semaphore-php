...
class EnvironmentRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'EnvironmentRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'json' => 'string',
        'env' => 'string',
        'secrets' => '\ClientAPI\Semaphore\Model\EnvironmentSecretRequest[]'
    ];
    ...
    */
    ...
    public function setProjectId(?int $projectId): static
    {
        ...
        if (($projectId < 1)) {
            throw new InvalidArgumentException('invalid value for $projectId when calling EnvironmentRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets secrets
     *
     * @return \ClientAPI\Semaphore\Model\EnvironmentSecretRequest[]|null
     */
     ...
     * Sets secrets
     *
     * @param \ClientAPI\Semaphore\Model\EnvironmentSecretRequest[]|null $secrets secrets
     *
     * @return $this
     */
