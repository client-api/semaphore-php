...
class RepositoryRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RepositoryRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('gitUrl', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($gitUrl)) {
            throw new InvalidArgumentException('non-nullable gitUrl cannot be null');
        }
