...
/**
 * IntegrationMatcher Class Doc Comment
 *
 * @package  ClientAPI\Semaphore
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class IntegrationMatcher implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'IntegrationMatcher';
    ...
    public const MATCH_TYPE_BODY = 'body';
    public const MATCH_TYPE_HEADER = 'header';
    public const METHOD_EQUALS = 'equals';
    public const METHOD_UNEQUALS = 'unequals';
    public const METHOD_CONTAINS = 'contains';
    ...
    public function getMethodAllowableValues()
    {
        return [
            self::METHOD_EQUALS,
            self::METHOD_UNEQUALS,
            self::METHOD_CONTAINS,
        ];
    }
    ...
    */
     ...
     * Sets integrationId
     *
     * @param int|null $integrationId integrationId
     *
     * @return $this
     */
