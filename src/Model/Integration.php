...
class Integration implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
    ...
    public function setProjectId(?int $projectId): static
    {
        ...
        if (($projectId < 1)) {
            throw new InvalidArgumentException('invalid value for $projectId when calling Integration., must be bigger than or equal to 1.');
        }
    ...
    public function setTemplateId(?int $templateId): static
    {
        ...
        if (($templateId < 1)) {
            throw new InvalidArgumentException('invalid value for $templateId when calling Integration., must be bigger than or equal to 1.');
        }
