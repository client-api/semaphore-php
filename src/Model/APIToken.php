...
class APIToken implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'APIToken';
    ...
    */
    ...
    public function setUserId(?int $userId): static
    {
        ...
        if (($userId < 1)) {
            throw new InvalidArgumentException('invalid value for $userId when calling APIToken., must be bigger than or equal to 1.');
        }
