...
class TemplateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $setters = [
        ...
        'buildTemplateId' => 'setBuildTemplateId',
        'autorun' => 'setAutorun'
    ];
    ...
    protected static array $getters = [
        ...
        'buildTemplateId' => 'getBuildTemplateId',
        'autorun' => 'getAutorun'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('startVersion', $data ?? [], null);
        $this->setIfExists('buildTemplateId', $data ?? [], null);
    ...
    */
    ...
    public function setProjectId(?int $projectId): static
    {
        ...
        if (($projectId < 1)) {
            throw new InvalidArgumentException('invalid value for $projectId when calling TemplateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setInventoryId(?int $inventoryId): static
    {
        ...
        if (($inventoryId < 1)) {
            throw new InvalidArgumentException('invalid value for $inventoryId when calling TemplateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setRepositoryId(?int $repositoryId): static
    {
        ...
        if (($repositoryId < 1)) {
            throw new InvalidArgumentException('invalid value for $repositoryId when calling TemplateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setEnvironmentId(?int $environmentId): static
    {
        ...
        if (($environmentId < 1)) {
            throw new InvalidArgumentException('invalid value for $environmentId when calling TemplateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setViewId(?int $viewId): static
    {
        ...
        if (($viewId < 1)) {
            throw new InvalidArgumentException('invalid value for $viewId when calling TemplateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets startVersion
     *
     * @param string|null $startVersion startVersion
     *
     * @return $this
     */
    public function setStartVersion(?string $startVersion): static
    {
        if (is_null($startVersion)) {
            throw new InvalidArgumentException('non-nullable startVersion cannot be null');
        }
    ...
    /**
     * Gets buildTemplateId
     *
     * @return int|null
     */
    public function getBuildTemplateId(): ?int
    {
        return $this->container['buildTemplateId'];
    }

    /**
     * Sets buildTemplateId
     *
     * @param int|null $buildTemplateId buildTemplateId
     *
     * @return $this
     */
    public function setBuildTemplateId(?int $buildTemplateId): static
    {
        if (is_null($buildTemplateId)) {
            throw new InvalidArgumentException('non-nullable buildTemplateId cannot be null');
        }
        $this->container['buildTemplateId'] = $buildTemplateId;
