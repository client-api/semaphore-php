...
/**
 * ProjectProjectIdTasksPostRequest Class Doc Comment
 *
 * @package  ClientAPI\Semaphore
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProjectProjectIdTasksPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_project__project_id__tasks_post_request';
    ...
    */
     ...
     * Sets diff
     *
     * @param bool|null $diff diff
     *
     * @return $this
     */
    public function setDiff(?bool $diff): static
    {
        if (is_null($diff)) {
