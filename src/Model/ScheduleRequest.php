...
class ScheduleRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ScheduleRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cronFormat', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getCronFormat(): ?string
    {
        return $this->container['cronFormat'];
    }

    /**
     * Sets cronFormat
     *
     * @param string|null $cronFormat cronFormat
     *
     * @return $this
     */
    public function setCronFormat(?string $cronFormat): static
    {
        if (is_null($cronFormat)) {
            throw new InvalidArgumentException('non-nullable cronFormat cannot be null');
        }
        $this->container['cronFormat'] = $cronFormat;
